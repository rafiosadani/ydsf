...
class Perprogram extends CI_Controller {
    ...
    function index() {
        ...
        $data['customjs'] = '';
        $data['datavalue'] = null;
        $data['forpage']['namahalaman'] = 'Laporan Per Program';
        $data['forpage']['post-controller'] = 'perprogram/tampil';
    ...
    function tampil(){
        if($this->input->post()){
            ...
            $data['a_program']=$this->m_program->get_program();
            ...
            $data['ramadhan_sekarang']= $this->m_program->get_ramadhan($min_sekarang, $max_sekarang,$this->input->post('idcabang'),'sekarang');
            $data['ramadhan_kemarin']= $this->m_program->get_ramadhan($min_kemarin, $max_kemarin,$this->input->post('idcabang'),'kemarin');

            $this->template->load('laporan', 'v_program', $data);
        }else{
