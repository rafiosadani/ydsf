...
<table class="table table-bordered">
    ...
    foreach ($ramadhan_kemarin as $value) {
        ...
        echo "<tr>
                <td>{$value['program']}</td>
                <td style='text-align: right'>{$value['jmltunai']}</td>
                <td style='text-align: right'>{$value['jmlbank']}</td>
                <td style='text-align: right'>{$value['jmltotal']}</td>
            </tr>";
        ...
        echo "<tr class='table-active'>
                <td>Total</td>
                <td style='text-align: right'>$totaltunai</td>
                <td style='text-align: right'>$totalbank</td>
