...
if ( ! function_exists('year_array'))
{
	/**
	 * Get array for combo
	 *
	 * Returns array for combo year
	 *
	 * @param	string
	 * @param	string
	 * @return	array
	 */
	function year_array($tahunkemarin = 5, $tahundepan=5)
	{
                $now_year= date('Y');
                $a_tahun[$now_year]=$now_year;
                
                for ($i=1;$i<=$tahunkemarin;$i++){
                    $tahun=$now_year-$i;
                    $a_tahun[$tahun]=$tahun;
                }
                for ($i=1;$i<=$tahundepan;$i++){
                    $tahun=$now_year+$i;
                    $a_tahun[$tahun]=$tahun;
                }
                ksort($a_tahun);
        ...
        function create_image($folder, $file, $class="img-thumbnail", $width=200){
            $baseurl= base_url();
            if($file==''|| !file_exists("./$folder/$file")){
                $folder='assets/images';
                $file='no-foto.png';
            }
            $image="<img src='$baseurl$folder/$file' class='$class' width='$width' alt='$file'>";
    ...
    function formatRupiah($angka, $pakai_rp=true){
        $desimal=0;
        $pemisahdesimal=",";
        $pemisahribuan=".";
        $rp='';
        ...
        return $rp." ".number_format($angka, $desimal, $pemisahdesimal, $pemisahribuan).$belakang;
    }
}