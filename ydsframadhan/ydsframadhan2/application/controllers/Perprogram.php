...
class Perprogram extends CI_Controller {
    ...
    function tampil(){
        if($this->input->post()){
            ...
            $data['ramadhan_sekarang']= $this->m_program->get_ramadhan($min_sekarang, $max_sekarang,$this->input->post('idcabang'));
            $data['ramadhan_kemarin']= $this->m_program->get_ramadhan($min_kemarin, $max_kemarin,$this->input->post('idcabang'));
