                    ...
                    <div class="box-body">
                      ...
                      <?php if ($this->session->userdata('admin') == TRUE) : ?>
                        ...
                        <div class="col-sm-5">
                          ...
                          <input id="kwsn" type="text" class="form-control" name="kwsn" placeholder="input kawasan"
                          required pattern=".{6,6}" title="kode kawasan harus 6 digit" value="<?php echo $data->kwsn ?>">
                        </div>
