    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Rinci Slip Bank</li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Rinci Slip Bank</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form class="form-horizontal" action="<?php echo base_url('keuangan/rinci-slip/bank/rekap') ?>" method="post" target="_blank">
                <div class="box-body">
