    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Per Program</li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Per Program</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              ...
              <form class="form-horizontal" action="<?php echo base_url('keuangan/program/rekap') ?>" method="post" target="_blank">
                <div class="box-body">
